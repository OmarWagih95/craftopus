...
function About() {
  return (
    <div id='about' className=' lg:bg-dodo lg:bg-fixed  bg-no-repeat bg-right   py-6 lg:pt-16 grid-cols-1 lg:grid-cols-2  lg:flex min-h-screen h-auto bg-gray-800 items-start justify-center'>
      {/* <div  className='grid-cols-1 lg:grid-cols-2 flex  h-5/6  w-11/12 border-2 border-gray-700 rounded-md'> */}
        <div className=' bg-opacity-10 h-1/2 relative my-8 flex justify-center lg:h-screen items-start lg:w-1/2'>
        ...
        <div className='bg-dodo h-[300px] bg-cover bg-right  lg:bg-none p-4 mt-72 w-screen lg:m-5 lg:w-1/2  text-white flex-col items-center justify-center text-center '>
